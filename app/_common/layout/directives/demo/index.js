...
export default (app) => {
  app.directive('demoStates', function ($rootScope, APP_CONFIG) {
    return {
      restrict: 'EA',
      replace: true,
      template: require('./demo-states.tpl.html'),
      scope: true,
      ...
      controller: function ($scope) {
        ...
        $scope.skins = APP_CONFIG.skins;

        $scope.smartSkin = localStorage.getItem('sm-skin') || APP_CONFIG.smartSkin;
